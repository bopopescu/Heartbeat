...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Tour.icon'
        db.alter_column('artists_tour', 'icon', self.gf('django.db.models.fields.files.ImageField')(max_length=100))

        # Changing field 'Album.cover'
        db.alter_column('artists_album', 'cover', self.gf('django.db.models.fields.files.ImageField')(max_length=100))

        # Changing field 'Concert.icon'
        db.alter_column('artists_concert', 'icon', self.gf('django.db.models.fields.files.ImageField')(max_length=100))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Tour.icon'
        db.alter_column('artists_tour', 'icon', self.gf('django.db.models.fields.files.FileField')(max_length=100))

        # Changing field 'Album.cover'
        db.alter_column('artists_album', 'cover', self.gf('django.db.models.fields.files.FileField')(max_length=100))

        # Changing field 'Concert.icon'
        db.alter_column('artists_concert', 'icon', self.gf('django.db.models.fields.files.FileField')(max_length=100))
