...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('userdata_subscription', (
        ...
        db.send_create_signal('userdata', ['Subscription'])

        # Adding model 'Notification'
        db.create_table('userdata_notification', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('profile', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['users.Profile'])),
    ...
    def backwards(self, orm):
        ...
        db.delete_table('userdata_subscription')
